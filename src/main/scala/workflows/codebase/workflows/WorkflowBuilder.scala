...
object WorkflowBuilder extends workflows.traits.Agent {
  ...
  override def prompt =
    """You are the resident expert in building workflows. You operate under workflows/src/main/scala/workflows.
